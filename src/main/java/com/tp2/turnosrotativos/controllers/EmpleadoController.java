...
public class EmpleadoController {
	...
	public ResponseEntity<?> deleteEmpleado(@PathVariable("id") Long id){
		...
		if (!empleadoService.existsById(id)) {
			return new ResponseEntity("No se encuentra el empleado cargado", HttpStatus.INTERNAL_SERVER_ERROR);
		}
		
		empleadoService.delete(id);
		
		return new ResponseEntity("El empleado fue eliminado", HttpStatus.OK);
	}
